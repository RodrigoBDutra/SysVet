...
public class JCalendar extends JComboBox {
  ...
  private JCalendar.DatePopup datePopup;
  ...
  private class MetalDateComboBoxUI extends MetalComboBoxUI {
    ...
    protected ComboPopup createPopup() {
      datePopup = new JCalendar.DatePopup();
      return datePopup;
    }
  }
  ...
  private class DatePopup extends BasicComboPopup {
    ...
    private JCalendar.DatePanel datePanel;
    ...
    public void constructDatePopup() {
      ...
      datePanel = new JCalendar.DatePanel();
      if (hasValidDate()) {
  ...
  public void updateUI() {
    ...
    if (comboBoxUI instanceof MetalComboBoxUI) {
      comboBoxUI = new JCalendar.MetalDateComboBoxUI();
    } else if (comboBoxUI instanceof MotifComboBoxUI) {
      comboBoxUI = new JCalendar.MotifDateComboBoxUI();
    } else if (comboBoxUI instanceof WindowsComboBoxUI) {
      comboBoxUI = new JCalendar.WindowsDateComboBoxUI();
    } else if (comboBoxUI instanceof BasicComboBoxUI) {
      comboBoxUI = new JCalendar.BasicDateComboBoxUI();
    }
