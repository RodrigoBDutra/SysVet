 ...
 * @author Rafael
 */
public class ProprietarioInserir extends javax.swing.JFrame {

    /**
     * Creates new form ProprietarioInserir
     */
    public ProprietarioInserir() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Inserir Proprietário");

        jPanel1.setBackground(new java.awt.Color(204, 204, 204));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Inserir Proprietário"));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "UF", "SP", "RJ", "ES", "MS", "CE" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProprietarioInserir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProprietarioInserir().setVisible(true);
            }
        });
    }
