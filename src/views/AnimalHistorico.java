 ...
 * @author Rafael
 */
public class AnimalHistorico extends javax.swing.JFrame {

    /**
     * Creates new form AnimalHistorico
     */
    public AnimalHistorico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Histórico Animal"));
        ...
        jPanel6.add(jPanel1);
        jPanel1.setBounds(11, 86, 613, 370);

        jButton21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/kedit.png"))); // NOI18N
        jButton21.setText("Prontuário");
        jPanel6.add(jButton21);
        jButton21.setBounds(390, 460, 113, 35);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel6.setText("Histórico do Animal");
        jPanel6.add(jLabel6);
        jLabel6.setBounds(271, 1, 119, 15);
        ...
        jButton14.setBounds(262, 461, 110, 32);
        ...
        jButton16.setBounds(521, 460, 103, 35);
        ...
        setSize(new java.awt.Dimension(975, 639));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnimalHistorico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnimalHistorico().setVisible(true);
            }
        });
    }
